...
public abstract class AppleDataBox extends AbstractBox
{
  ...
  public String getLanguageString()
  {
    ...
    if (str == null)
    {
      ...
      IsoTypeWriter.writeUInt16(localByteBuffer, this.dataLanguage);
      localByteBuffer.reset();
      str = new Locale(IsoTypeReader.readIso639(localByteBuffer)).getDisplayLanguage();
    }
    return str;
  }
  ...
  protected ByteBuffer parseDataLength4ccTypeCountryLanguageAndReturnRest(ByteBuffer paramByteBuffer)
  {
    ...
    if (this.dataCountry < 0)
      this.dataCountry = (65536 + this.dataCountry);
    this.dataLanguage = paramByteBuffer.getShort();
    if (this.dataLanguage < 0)
      this.dataLanguage = (65536 + this.dataLanguage);
  ...
  {
    paramByteBuffer.putInt(16 + getDataLength());
