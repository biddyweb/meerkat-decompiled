  ...
  implements FilteredMultimap<K, V>
{
  ...
  static class AddRejectingList<K, V> extends ForwardingList<V>
  {
    ...
    public void add(int paramInt, V paramV)
    {
      ...
      throw new IllegalArgumentException(32 + str.length() + "Key does not satisfy predicate: " + str);
    }
  ...
  class Entries extends ForwardingCollection<Map.Entry<K, V>>
  {
    ...
    public boolean remove(@Nullable Object paramObject)
    {
      if ((paramObject instanceof Map.Entry))
      {
        ...
        if ((FilteredKeyMultimap.this.unfiltered.containsKey(localEntry.getKey())) && (FilteredKeyMultimap.this.keyPredicate.apply(localEntry.getKey())))
