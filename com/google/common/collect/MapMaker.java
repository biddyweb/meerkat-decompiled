...
public final class MapMaker extends GenericMapMaker<Object, Object>
{
  ...
  @Deprecated
  <K, V> ConcurrentMap<K, V> makeComputingMap(Function<? super K, ? extends V> paramFunction)
  {
    if (this.nullRemovalCause == null);
    for (Object localObject = new ComputingMapAdapter(this, paramFunction); ; localObject = new NullComputingConcurrentMap(this, paramFunction))
  ...
  public String toString()
  {
    ...
    if (this.expireAfterWriteNanos != -1L)
    {
      ...
      localToStringHelper.add("expireAfterWrite", 22 + l2 + "ns");
    }
    if (this.expireAfterAccessNanos != -1L)
    {
    ...
    implements Serializable
  {
    ...
    public V get(Object paramObject)
    {
      ...
      try
      {
        ...
        if (localObject == null)
        {
          String str1 = String.valueOf(String.valueOf(this.computingFunction));
          String str2 = String.valueOf(String.valueOf(paramObject));
          throw new NullPointerException(24 + str1.length() + str2.length() + str1 + " returned null for key " + str2 + ".");
        }
      }
  ...
  static final class NullComputingConcurrentMap<K, V> extends MapMaker.NullConcurrentMap<K, V>
  {
    ...
    public V get(Object paramObject)
    {
      ...
      arrayOfObject[0] = this.computingFunction;
      arrayOfObject[1] = paramObject;
      Preconditions.checkNotNull(localObject, "%s returned null for key %s.", arrayOfObject);
  ...
  static abstract enum RemovalCause
  {
    ...
    {
      // Byte code:
      //   0: new 17\011com/google/common/collect/MapMaker$RemovalCause$1
      //   3: dup
      //   4: ldc 18
      //   6: iconst_0
      //   7: invokespecial 22\011com/google/common/collect/MapMaker$RemovalCause$1:<init>\011(Ljava/lang/String;I)V
      //   10: putstatic 24\011com/google/common/collect/MapMaker$RemovalCause:EXPLICIT\011Lcom/google/common/collect/MapMaker$RemovalCause;
      //   13: new 26\011com/google/common/collect/MapMaker$RemovalCause$2
      //   16: dup
      //   17: ldc 27
      //   19: iconst_1
      //   20: invokespecial 28\011com/google/common/collect/MapMaker$RemovalCause$2:<init>\011(Ljava/lang/String;I)V
      //   23: putstatic 30\011com/google/common/collect/MapMaker$RemovalCause:REPLACED\011Lcom/google/common/collect/MapMaker$RemovalCause;
      //   26: new 32\011com/google/common/collect/MapMaker$RemovalCause$3
      //   29: dup
      //   30: ldc 33
      //   32: iconst_2
      //   33: invokespecial 34\011com/google/common/collect/MapMaker$RemovalCause$3:<init>\011(Ljava/lang/String;I)V
      //   36: putstatic 36\011com/google/common/collect/MapMaker$RemovalCause:COLLECTED\011Lcom/google/common/collect/MapMaker$RemovalCause;
      //   39: new 38\011com/google/common/collect/MapMaker$RemovalCause$4
      //   42: dup
      //   43: ldc 39
      //   45: iconst_3
      //   46: invokespecial 40\011com/google/common/collect/MapMaker$RemovalCause$4:<init>\011(Ljava/lang/String;I)V
      //   49: putstatic 42\011com/google/common/collect/MapMaker$RemovalCause:EXPIRED\011Lcom/google/common/collect/MapMaker$RemovalCause;
      //   52: new 44\011com/google/common/collect/MapMaker$RemovalCause$5
      //   55: dup
      //   56: ldc 45
      //   58: iconst_4
      //   59: invokespecial 46\011com/google/common/collect/MapMaker$RemovalCause$5:<init>\011(Ljava/lang/String;I)V
      //   62: putstatic 48\011com/google/common/collect/MapMaker$RemovalCause:SIZE\011Lcom/google/common/collect/MapMaker$RemovalCause;
      //   65: iconst_5
      //   66: anewarray 2\011com/google/common/collect/MapMaker$RemovalCause
      //   69: astore_0
      //   70: aload_0
      //   71: iconst_0
      //   72: getstatic 24\011com/google/common/collect/MapMaker$RemovalCause:EXPLICIT\011Lcom/google/common/collect/MapMaker$RemovalCause;
      //   75: aastore
      //   76: aload_0
      //   77: iconst_1
      //   78: getstatic 30\011com/google/common/collect/MapMaker$RemovalCause:REPLACED\011Lcom/google/common/collect/MapMaker$RemovalCause;
      //   81: aastore
      //   82: aload_0
      //   83: iconst_2
      //   84: getstatic 36\011com/google/common/collect/MapMaker$RemovalCause:COLLECTED\011Lcom/google/common/collect/MapMaker$RemovalCause;
      //   87: aastore
      //   88: aload_0
      //   89: iconst_3
      //   90: getstatic 42\011com/google/common/collect/MapMaker$RemovalCause:EXPIRED\011Lcom/google/common/collect/MapMaker$RemovalCause;
      //   93: aastore
      //   94: aload_0
      //   95: iconst_4
      //   96: getstatic 48\011com/google/common/collect/MapMaker$RemovalCause:SIZE\011Lcom/google/common/collect/MapMaker$RemovalCause;
      //   99: aastore
      //   100: aload_0
      //   101: putstatic 50\011com/google/common/collect/MapMaker$RemovalCause:$VALUES\011[Lcom/google/common/collect/MapMaker$RemovalCause;
      //   104: return
    }
