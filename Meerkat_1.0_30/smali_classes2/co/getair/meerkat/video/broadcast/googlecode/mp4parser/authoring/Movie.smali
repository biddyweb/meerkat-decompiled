.class public Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;
.super Ljava/lang/Object;
.source "Movie.java"


# instance fields
.field matrix:Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/util/Matrix;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->matrix:Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/util/Matrix;
    ...
    iput-object v0, p0, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->tracks:Ljava/util/List;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    .line 33
    iput-object p1, p0, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->tracks:Ljava/util/List;
...
.method public static gcd(JJ)J
    ...
    invoke-static {p2, p3, v0, v1}, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->gcd(JJ)J
...
# virtual methods
.method public addTrack(Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Track;)V
    .locals 4
    .param p1, "nuTrack"    # Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Track;
    ...
    invoke-virtual {v0}, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/TrackMetaData;->getTrackId()J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->getTrackByTrackId(J)Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Track;
    ...
    invoke-virtual {p0}, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->getNextTrackId()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/TrackMetaData;->setTrackId(J)V

    .line 53
    :cond_0
    iget-object v0, p0, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->tracks:Ljava/util/List;
...
.method public getMatrix()Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/util/Matrix;
    ...
    .prologue
    .line 96
    iget-object v0, p0, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->matrix:Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/util/Matrix;
...
.method public getNextTrackId()J
    ...
    iget-object v3, p0, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->tracks:Ljava/util/List;
    ...
    invoke-virtual {v4}, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/TrackMetaData;->getTrackId()J
...
.method public getTimescale()J
    ...
    invoke-static {v4, v5, v0, v1}, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->gcd(JJ)J
...
.method public getTrackByTrackId(J)Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Track;
    .locals 5
    .param p1, "trackId"    # J

    .prologue
    .line 78
    iget-object v1, p0, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->tracks:Ljava/util/List;
...
.method public setMatrix(Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/util/Matrix;)V
    ...
    .prologue
    .line 100
    iput-object p1, p0, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->matrix:Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/util/Matrix;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Movie;->tracks:Ljava/util/List;
    ...
    invoke-interface {v1}, Lco/getair/meerkat/video/broadcast/googlecode/mp4parser/authoring/Track;->getHandler()Ljava/lang/String;
