...
public final class InternetDomainName
{
  ...
  private static boolean matchesWildcardPublicSuffix(String paramString)
  {
    ...
    return (arrayOfString.length == 2) && (PublicSuffixPatterns.UNDER.containsKey(arrayOfString[1]));
  }
  ...
  {
    String str1 = String.valueOf(String.valueOf((String)Preconditions.checkNotNull(paramString)));
    String str2 = String.valueOf(String.valueOf(this.name));
    return from(1 + str1.length() + str2.length() + str1 + "." + str2);
  }
