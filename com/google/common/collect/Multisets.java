...
public final class Multisets
{
  ...
  {
    if ((paramIterable instanceof Multiset))
      return removeOccurrencesImpl(paramMultiset, (Multiset)paramIterable);
    return removeOccurrencesImpl(paramMultiset, paramIterable);
  }
  ...
  private static boolean removeOccurrencesImpl(Multiset<?> paramMultiset, Iterable<?> paramIterable)
  {
    Preconditions.checkNotNull(paramMultiset);
    ...
    while (localIterator.hasNext())
      bool |= paramMultiset.remove(localIterator.next());
    return bool;
  }
    ...
    implements Multiset.Entry<E>
  {
    ...
    {
      String str1 = String.valueOf(getElement());
      int i = getCount();
      if (i == 1)
        return str1;
      String str2 = String.valueOf(String.valueOf(str1));
      return 14 + str2.length() + str2 + " x " + i;
    }
  }
