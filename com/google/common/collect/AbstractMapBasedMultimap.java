  ...
  implements Serializable
{
  ...
  {
    // Byte code:
    //   0: new 169\011com/google/common/collect/AbstractMapBasedMultimap$2
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 172\011com/google/common/collect/AbstractMapBasedMultimap$2:<init>\011(Lcom/google/common/collect/AbstractMapBasedMultimap;)V
    //   8: areturn
  }
  ...
  {
    // Byte code:
    //   0: new 232\011com/google/common/collect/AbstractMapBasedMultimap$1
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 233\011com/google/common/collect/AbstractMapBasedMultimap$1:<init>\011(Lcom/google/common/collect/AbstractMapBasedMultimap;)V
    //   8: areturn
  }
  ...
  private class KeySet extends Maps.KeySet<K, Collection<V>>
  {
    ...
    public boolean remove(Object paramObject)
    {
      Collection localCollection = (Collection)map().remove(paramObject);
      int i = 0;
      if (localCollection != null)
      {
        i = localCollection.size();
    ...
    implements NavigableMap<K, Collection<V>>
  {
    ...
    {
      Map.Entry localEntry = sortedMap().ceilingEntry(paramK);
      if (localEntry == null)
        return null;
    ...
    {
      Map.Entry localEntry = sortedMap().floorEntry(paramK);
      if (localEntry == null)
        return null;
      return wrapEntry(localEntry);
    }
    ...
    {
      Map.Entry localEntry = sortedMap().higherEntry(paramK);
      if (localEntry == null)
        return null;
      return wrapEntry(localEntry);
    }
    ...
    {
      Map.Entry localEntry = sortedMap().lowerEntry(paramK);
      if (localEntry == null)
        return null;
      return wrapEntry(localEntry);
    }
  ...
  {
    WrappedNavigableSet(NavigableSet<V> paramAbstractMapBasedMultimap, @Nullable AbstractMapBasedMultimap<K, V>.WrappedCollection arg3)
    {
      super(paramAbstractMapBasedMultimap, localSortedSet, localWrappedCollection);
    }
    ...
    private NavigableSet<V> wrap(NavigableSet<V> paramNavigableSet)
    {
      ...
      while (true)
      {
        return new WrappedNavigableSet(localAbstractMapBasedMultimap, localObject, paramNavigableSet, this);
        this = getAncestor();
      }
    }
