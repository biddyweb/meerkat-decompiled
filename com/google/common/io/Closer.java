  ...
  implements Closeable
{
    ...
    implements Closer.Suppressor
  {
    ...
    {
      Logger localLogger = Closeables.logger;
      Level localLevel = Level.WARNING;
      String str = String.valueOf(String.valueOf(paramCloseable));
      localLogger.log(localLevel, 42 + str.length() + "Suppressing exception thrown when closing " + str, paramThrowable2);
    }
  }
