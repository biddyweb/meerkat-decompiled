  ...
  implements Observable.Operator<List<T>, T>
{
  ...
  final class InexactSubscriber extends Subscriber<T>
  {
    ...
    public void onCompleted()
    {
      ...
      //   1: monitorenter
      //   2: aload_0
      //   3: getfield 39\011rx/internal/operators/OperatorBufferWithTime$InexactSubscriber:done\011Z
      //   6: ifeq +6 -> 12
      //   9: aload_0
      //   10: monitorexit
      //   11: return
      //   12: aload_0
      //   13: iconst_1
      //   14: putfield 39\011rx/internal/operators/OperatorBufferWithTime$InexactSubscriber:done\011Z
      //   17: new 30\011java/util/LinkedList
      //   20: dup
      //   21: aload_0
      //   22: getfield 33\011rx/internal/operators/OperatorBufferWithTime$InexactSubscriber:chunks\011Ljava/util/List;
      //   25: invokespecial 70\011java/util/LinkedList:<init>\011(Ljava/util/Collection;)V
      //   28: astore_3
      //   29: aload_0
      //   30: getfield 33\011rx/internal/operators/OperatorBufferWithTime$InexactSubscriber:chunks\011Ljava/util/List;
      ...
      //   65: checkcast 41\011java/util/List
      //   68: astore 5
      //   70: aload_0
      //   71: getfield 26\011rx/internal/operators/OperatorBufferWithTime$InexactSubscriber:child\011Lrx/Subscriber;
      //   74: aload 5
      //   76: invokevirtual 62\011rx/Subscriber:onNext\011(Ljava/lang/Object;)V
      //   79: goto -31 -> 48
      //   82: astore_1
      //   83: aload_0
      //   84: getfield 26\011rx/internal/operators/OperatorBufferWithTime$InexactSubscriber:child\011Lrx/Subscriber;
      //   87: aload_1
      //   88: invokevirtual 74\011rx/Subscriber:onError\011(Ljava/lang/Throwable;)V
      //   91: return
      //   92: astore_2
      //   93: aload_0
      //   94: monitorexit
      ...
      //   96: athrow
      //   97: aload_0
      //   98: getfield 26\011rx/internal/operators/OperatorBufferWithTime$InexactSubscriber:child\011Lrx/Subscriber;
      //   101: invokevirtual 76\011rx/Subscriber:onCompleted\011()V
      //   104: aload_0
      //   105: invokevirtual 79\011rx/internal/operators/OperatorBufferWithTime$InexactSubscriber:unsubscribe\011()V
      //   108: return
      //
      // Exception table:
    ...
    public void onNext(T paramT)
    {
      ...
      //   11: return
      //   12: aload_0
      //   13: getfield 33\011rx/internal/operators/OperatorBufferWithTime$InexactSubscriber:chunks\011Ljava/util/List;
      ...
      //   40: checkcast 41\011java/util/List
      //   43: astore 9
      //   45: aload 9
      //   47: aload_1
      ...
      //   61: aload_0
      //   62: getfield 21\011rx/internal/operators/OperatorBufferWithTime$InexactSubscriber:this$0\011Lrx/internal/operators/OperatorBufferWithTime;
      //   65: getfield 93\011rx/internal/operators/OperatorBufferWithTime:count\011I
      //   68: if_icmpne +113 -> 181
      //   71: aload_3
      //   72: invokeinterface 58 1 0
      //   77: aload 4
      //   79: ifnonnull +95 -> 174
      //   82: new 30\011java/util/LinkedList
      //   85: dup
      //   86: invokespecial 31\011java/util/LinkedList:<init>\011()V
      //   89: astore 11
      //   91: aload 11
      //   93: aload 9
      ...
      //   141: checkcast 41\011java/util/List
      //   144: astore 8
      //   146: aload_0
      //   147: getfield 26\011rx/internal/operators/OperatorBufferWithTime$InexactSubscriber:child\011Lrx/Subscriber;
      //   150: aload 8
      //   152: invokevirtual 62\011rx/Subscriber:onNext\011(Ljava/lang/Object;)V
      //   155: goto -31 -> 124
      //   158: astore_2
      //   159: aload_0
      //   160: monitorexit
      ...
      // Exception table:
      //   from\011to\011target\011type
      //   2\01111\011158\011finally
      //   12\01122\011158\011finally
      //   91\011101\011158\011finally
      //   159\011161\011158\011finally
      //   25\01177\011167\011finally
      //   82\01191\011167\011finally
      //   108\011110\011167\011finally
    }
