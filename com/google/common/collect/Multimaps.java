...
public final class Multimaps
{
  ...
  static boolean equalsImpl(Multimap<?, ?> paramMultimap, @Nullable Object paramObject)
  {
    ...
    if ((paramObject instanceof Multimap))
    {
      ...
      return paramMultimap.asMap().equals(localMultimap.asMap());
    }
    return false;
  }
  ...
  {
    Predicate localPredicate = Predicates.and(paramFilteredSetMultimap.entryPredicate(), paramPredicate);
    return new FilteredEntrySetMultimap(paramFilteredSetMultimap.unfiltered(), localPredicate);
  }
  ...
  public static <K, V> ListMultimap<K, V> filterKeys(ListMultimap<K, V> paramListMultimap, Predicate<? super K> paramPredicate)
  {
    ...
    {
      FilteredKeyListMultimap localFilteredKeyListMultimap = (FilteredKeyListMultimap)paramListMultimap;
      return new FilteredKeyListMultimap(localFilteredKeyListMultimap.unfiltered(), Predicates.and(localFilteredKeyListMultimap.keyPredicate, paramPredicate));
    }
  ...
  public static <K, V> Multimap<K, V> filterKeys(Multimap<K, V> paramMultimap, Predicate<? super K> paramPredicate)
  {
    ...
    if ((paramMultimap instanceof FilteredKeyMultimap))
    {
      ...
      return new FilteredKeyMultimap(localFilteredKeyMultimap.unfiltered, Predicates.and(localFilteredKeyMultimap.keyPredicate, paramPredicate));
    }
    if ((paramMultimap instanceof FilteredMultimap))
  ...
  public static <K, V> SetMultimap<K, V> filterKeys(SetMultimap<K, V> paramSetMultimap, Predicate<? super K> paramPredicate)
  {
    ...
    {
      FilteredKeySetMultimap localFilteredKeySetMultimap = (FilteredKeySetMultimap)paramSetMultimap;
      return new FilteredKeySetMultimap(localFilteredKeySetMultimap.unfiltered(), Predicates.and(localFilteredKeySetMultimap.keyPredicate, paramPredicate));
    }
    if ((paramSetMultimap instanceof FilteredSetMultimap))
  ...
  static final class AsMap<K, V> extends Maps.ImprovedAbstractMap<K, Collection<V>>
  {
    ...
    class EntrySet extends Maps.EntrySet<K, Collection<V>>
    {
      ...
      {
        return Maps.asMapEntryIterator(Multimaps.AsMap.this.multimap.keySet(), new Function()
        {
        ...
        public Iterator<V> iterator()
        {
          return new Iterator()
          {
            ...
            public void remove()
            {
              ...
              while (true)
              {
                CollectPreconditions.checkRemove(j);
                this.i = -1;
  ...
  private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2>
  {
    ...
    {
      Function localFunction = Maps.asValueToValueFunction(this.transformer, paramK);
      if ((paramCollection instanceof List))
        return Lists.transform((List)paramCollection, localFunction);
      return Collections2.transform(paramCollection, localFunction);
    }
  }
    ...
    implements Serializable
  {
    ...
    public Map<K, Collection<V>> asMap()
    {
      ...
      if (localMap == null)
      {
        localMap = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new Function()
        {
