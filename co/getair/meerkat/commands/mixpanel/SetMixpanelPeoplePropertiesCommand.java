...
public class SetMixpanelPeoplePropertiesCommand extends SimpleCommand
{
  public void execute(INotification paramINotification)
  {
    ...
    ((MixpanelProxy)getFacade().retrieveProxy("mixpanelProxy")).setPeopleProperties(localJSONObject);
  }
}