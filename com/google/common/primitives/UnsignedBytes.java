...
public final class UnsignedBytes
{
  ...
  public static byte parseUnsignedByte(String paramString, int paramInt)
  {
    ...
    if (i >> 8 == 0)
      return (byte)i;
    throw new NumberFormatException(25 + "out of range: " + i);
  }
      ...
      public int compare(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
      {
        ...
        for (int k = 0; k < j * 8; k += 8)
        {
          ...
          if (l1 != l2)
          {
            ...
            int i1 = 0xFFFFFFF8 & Long.numberOfTrailingZeros(l1 ^ l2);
            return (int)((0xFF & l1 >>> i1) - (0xFF & l2 >>> i1));
          }
        }
        for (int m = j * 8; ; m++)
        {
        ...
        label164: return paramArrayOfByte1.length - paramArrayOfByte2.length;
      }
    }
  }
}