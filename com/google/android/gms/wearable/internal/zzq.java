  ...
  implements Parcelable.Creator<zzp>
{
  static void zza(zzp paramzzp, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, paramzzp.zzFG);
    zzb.zza(paramParcel, 2, paramzzp.getUri(), paramInt, false);
    zzb.zza(paramParcel, 4, paramzzp.zzuY(), false);
    zzb.zza(paramParcel, 5, paramzzp.getData(), false);
    zzb.zzH(paramParcel, i);
  }

  public zzp zzfx(Parcel paramParcel)
  {
    ...
    return new zzp(j, localObject3, localObject2, localObject1);
  }

  public zzp[] zzhX(int paramInt)
  {
