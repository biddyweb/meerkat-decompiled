...
public class IncrementMixpanelPeoplePropertyCommand extends SimpleCommand
{
  public void execute(INotification paramINotification)
  {
    ...
    ((MixpanelProxy)getFacade().retrieveProxy("mixpanelProxy")).incrementPeopleProperty(str);
  }
}