...
public abstract interface zzwc extends IInterface
{
    ...
    implements zzwc
  {
    ...
    public static zzwc zzcI(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzwc)))
        return (zzwc)localIInterface;
