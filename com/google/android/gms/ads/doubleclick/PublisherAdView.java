...
public final class PublisherAdView extends ViewGroup
{
  ...
  public PublisherAdView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.zzll = new zzbp(this, paramAttributeSet, true);
  }
  ...
  {
    this.zzll.zza(paramPublisherAdRequest.zzY());
  }
  ...
  public void setAdSizes(AdSize[] paramArrayOfAdSize)
  {
    ...
    this.zzll.zza(paramArrayOfAdSize);
  }
  ...
  {
    this.zzll.setAppEventListener(paramAppEventListener);
  }

  public void setOnCustomRenderedAdLoadedListener(OnCustomRenderedAdLoadedListener paramOnCustomRenderedAdLoadedListener)
  {
    this.zzll.setOnCustomRenderedAdLoadedListener(paramOnCustomRenderedAdLoadedListener);
  }
}