  ...
  implements BiMap<K, V>, Serializable
{
  ...
  private V put(@Nullable K paramK, @Nullable V paramV, boolean paramBoolean)
  {
    ...
    label162: for (Object localObject = null; ; localObject = localBiEntry1.value)
    {
      return localObject;
      String str = String.valueOf(String.valueOf(paramV));
      throw new IllegalArgumentException(23 + str.length() + "value already present: " + str);
    }
  }
  ...
  private K putInverse(@Nullable V paramV, @Nullable K paramK, boolean paramBoolean)
  {
    ...
    label162: for (Object localObject = null; ; localObject = localBiEntry1.key)
    {
      return localObject;
  ...
  private final class EntrySet extends Maps.EntrySet<K, V>
  {
    ...
    {
      // Byte code:
      //   0: new 21\011com/google/common/collect/HashBiMap$EntrySet$1
      //   3: dup
      //   4: aload_0
      //   5: invokespecial 24\011com/google/common/collect/HashBiMap$EntrySet$1:<init>\011(Lcom/google/common/collect/HashBiMap$EntrySet;)V
      //   8: areturn
    }
    ...
    implements BiMap<V, K>, Serializable
  {
    ...
    public Set<Map.Entry<V, K>> entrySet()
    {
      return new Maps.EntrySet()
      {
        ...
        {
          // Byte code:
          //   0: new 23\011com/google/common/collect/HashBiMap$Inverse$1$1
          //   3: dup
          //   4: aload_0
          //   5: invokespecial 26\011com/google/common/collect/HashBiMap$Inverse$1$1:<init>\011(Lcom/google/common/collect/HashBiMap$Inverse$1;)V
          //   8: areturn
        }
    ...
    {
      HashBiMap.BiEntry localBiEntry = HashBiMap.this.seekByValue(paramObject, HashBiMap.access$300(paramObject));
      if (localBiEntry == null)
        return null;
    ...
    private final class InverseKeySet extends Maps.KeySet<V, K>
    {
      ...
      {
        // Byte code:
        //   0: new 18\011com/google/common/collect/HashBiMap$Inverse$InverseKeySet$1
        //   3: dup
        //   4: aload_0
        //   5: invokespecial 21\011com/google/common/collect/HashBiMap$Inverse$InverseKeySet$1:<init>\011(Lcom/google/common/collect/HashBiMap$Inverse$InverseKeySet;)V
        //   8: areturn
      }
  ...
  private final class KeySet extends Maps.KeySet<K, V>
  {
    ...
    {
      // Byte code:
      //   0: new 18\011com/google/common/collect/HashBiMap$KeySet$1
      //   3: dup
      //   4: aload_0
      //   5: invokespecial 21\011com/google/common/collect/HashBiMap$KeySet$1:<init>\011(Lcom/google/common/collect/HashBiMap$KeySet;)V
      //   8: areturn
    }

    public boolean remove(@Nullable Object paramObject)
    {
      HashBiMap.BiEntry localBiEntry = HashBiMap.this.seekByKey(paramObject, HashBiMap.access$300(paramObject));
      if (localBiEntry == null)
        return false;
      HashBiMap.this.delete(localBiEntry);
      return true;
