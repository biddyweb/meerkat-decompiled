    ...
    implements Parcelable
  {
    public static final Parcelable.Creator<DisplayState> CREATOR = new Parcelable.Creator()
    {
      public UpdateDisplayState.DisplayState createFromParcel(Parcel paramAnonymousParcel)
      {
        ...
        if ("SurveyState".equals(str))
          return new UpdateDisplayState.DisplayState.SurveyState(localBundle2, null);
    ...
    public static final class SurveyState extends UpdateDisplayState.DisplayState
    {
      ...
      public void writeToParcel(Parcel paramParcel, int paramInt)
      {
        ...
        Bitmap localBitmap = this.mBackground;
        byte[] arrayOfByte = null;
        if (localBitmap != null)
        {
          ByteArrayOutputStream localByteArrayOutputStream = new ByteArrayOutputStream();
          this.mBackground.compress(Bitmap.CompressFormat.PNG, 20, localByteArrayOutputStream);
