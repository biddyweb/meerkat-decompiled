  ...
  implements Parcelable.Creator<OnSyncMoreResponse>
{
  static void zza(OnSyncMoreResponse paramOnSyncMoreResponse, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, paramOnSyncMoreResponse.zzFG);
    zzb.zza(paramParcel, 2, paramOnSyncMoreResponse.zzTB);
    zzb.zzH(paramParcel, i);
  }

  public OnSyncMoreResponse zzaP(Parcel paramParcel)
  {
    boolean bool = false;
  ...
  public OnSyncMoreResponse[] zzci(int paramInt)
  {
