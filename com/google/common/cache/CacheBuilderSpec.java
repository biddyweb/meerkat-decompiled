...
public final class CacheBuilderSpec
{
  ...
  public int hashCode()
  {
    ...
    arrayOfObject[6] = this.recordStats;
    arrayOfObject[7] = durationInNanos(this.writeExpirationDuration, this.writeExpirationTimeUnit);
    arrayOfObject[8] = durationInNanos(this.accessExpirationDuration, this.accessExpirationTimeUnit);
    arrayOfObject[9] = durationInNanos(this.refreshDuration, this.refreshTimeUnit);
    ...
    implements CacheBuilderSpec.ValueParser
  {
    public void parse(CacheBuilderSpec paramCacheBuilderSpec, String paramString1, String paramString2)
    {
      ...
      for (boolean bool = true; ; bool = false)
      {
        ...
        try
        {
          switch (paramString2.charAt(-1 + paramString2.length()))
          {
          default:
      ...
      while (true)
      {
        parseDuration(paramCacheBuilderSpec, Long.parseLong(paramString2.substring(0, -1 + paramString2.length())), localTimeUnit);
        return;
    ...
    implements CacheBuilderSpec.ValueParser
  {
    public void parse(CacheBuilderSpec paramCacheBuilderSpec, String paramString1, @Nullable String paramString2)
    {
      ...
      for (boolean bool1 = true; ; bool1 = false)
      {
        ...
        Boolean localBoolean = paramCacheBuilderSpec.recordStats;
        boolean bool2 = false;
