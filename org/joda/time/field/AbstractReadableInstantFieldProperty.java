  ...
  implements Serializable
{
  ...
  {
    if (this == paramObject);
    AbstractReadableInstantFieldProperty localAbstractReadableInstantFieldProperty;
    do
    {
      return true;
      if (!(paramObject instanceof AbstractReadableInstantFieldProperty))
        return false;
      localAbstractReadableInstantFieldProperty = (AbstractReadableInstantFieldProperty)paramObject;
    }
    while ((get() == localAbstractReadableInstantFieldProperty.get()) && (getFieldType().equals(localAbstractReadableInstantFieldProperty.getFieldType())) && (FieldUtils.equals(getChronology(), localAbstractReadableInstantFieldProperty.getChronology())));
    return false;
  }
  ...
  public int hashCode()
  {
    return 17 * get() + getFieldType().hashCode() + getChronology().hashCode();
  }
