...
public final class Suppliers
{
    ...
    implements Supplier<T>, Serializable
  {
    ...
    public String toString()
    {
      ...
      return 62 + str.length() + "Suppliers.memoizeWithExpiration(" + str + ", " + l + ", NANOS)";
    }
  }
    ...
    implements Supplier<T>, Serializable
  {
    ...
    {
      String str = String.valueOf(String.valueOf(this.delegate));
      return 19 + str.length() + "Suppliers.memoize(" + str + ")";
    }
  }
    ...
    implements Supplier<T>, Serializable
  {
    ...
    public String toString()
    {
      String str1 = String.valueOf(String.valueOf(this.function));
      String str2 = String.valueOf(String.valueOf(this.supplier));
      return 21 + str1.length() + str2.length() + "Suppliers.compose(" + str1 + ", " + str2 + ")";
    }
  }
    ...
    implements Suppliers.SupplierFunction<Object>
  {
    static
    {
      SupplierFunctionImpl[] arrayOfSupplierFunctionImpl = new SupplierFunctionImpl[1];
      arrayOfSupplierFunctionImpl[0] = INSTANCE;
    }
    ...
    implements Supplier<T>, Serializable
  {
    ...
    public String toString()
    {
      ...
      return 22 + str.length() + "Suppliers.ofInstance(" + str + ")";
    }
  }
    ...
    implements Supplier<T>, Serializable
  {
    ...
    {
      String str = String.valueOf(String.valueOf(this.delegate));
      return 32 + str.length() + "Suppliers.synchronizedSupplier(" + str + ")";
    }
  }
}