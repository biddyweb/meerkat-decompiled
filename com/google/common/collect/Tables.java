...
public final class Tables
{
  ...
  static boolean equalsImpl(Table<?, ?, ?> paramTable, @Nullable Object paramObject)
  {
    ...
    if ((paramObject instanceof Table))
    {
      ...
      return paramTable.cellSet().equals(localTable.cellSet());
    }
    return false;
  }
    ...
    implements Table.Cell<R, C, V>
  {
    ...
    {
      String str1 = String.valueOf(String.valueOf(getRowKey()));
      String str2 = String.valueOf(String.valueOf(getColumnKey()));
      String str3 = String.valueOf(String.valueOf(getValue()));
      return 4 + str1.length() + str2.length() + str3.length() + "(" + str1 + "," + str2 + ")=" + str3;
    }
  }
