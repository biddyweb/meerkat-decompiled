...
public abstract class Equivalence<T>
{
    ...
    implements Predicate<T>, Serializable
  {
    ...
    {
      String str1 = String.valueOf(String.valueOf(this.equivalence));
      String str2 = String.valueOf(String.valueOf(this.target));
      return 15 + str1.length() + str2.length() + str1 + ".equivalentTo(" + str2 + ")";
    }
  }
    ...
    implements Serializable
  {
    ...
    public boolean equals(@Nullable Object paramObject)
    {
      ...
      if ((paramObject instanceof Wrapper))
      {
        ...
        if (this.equivalence.equals(localWrapper.equivalence))
          return this.equivalence.equivalent(this.reference, localWrapper.reference);
      }
      return false;
    }
    ...
    {
      String str1 = String.valueOf(String.valueOf(this.equivalence));
      String str2 = String.valueOf(String.valueOf(this.reference));
      return 7 + str1.length() + str2.length() + str1 + ".wrap(" + str2 + ")";
    }
  }
}