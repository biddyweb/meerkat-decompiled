    ...
    if (!this.mSubDecorInstalled)
    {
      ...
      while (this.mSubDecor == null)
      {
        ...
        if (this.mHasActionBar)
        {
          ...
          label300: ((FitWindowsViewGroup)this.mSubDecor).setOnFitSystemWindowsListener(new FitWindowsViewGroup.OnFitSystemWindowsListener()
          {
  ...
  ActionMode startSupportActionModeFromWindow(ActionMode.Callback paramCallback)
  {
    ...
    else if (this.mActionModeView != null)
    {
      ...
      if (this.mActionModePopup != null)
        break label481;
      bool = true;
      label280: StandaloneActionMode localStandaloneActionMode = new StandaloneActionMode(localContext, localActionBarContextView, localActionModeCallbackWrapper, bool);
    ...
    while (true)
    {
      ...
      break;
      label434: ViewStubCompat localViewStubCompat = (ViewStubCompat)this.mSubDecor.findViewById(R.id.action_mode_bar_stub);
      ...
      label481: bool = false;
      break label280;
      label487: this.mActionMode = null;
    }
  }
