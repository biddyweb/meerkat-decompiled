...
public final class ByteStreams
{
    ...
    throws IOException
  {
    ...
    {
      FileChannel localFileChannel = (FileChannel)paramReadableByteChannel;
      long l2 = localFileChannel.position();
      long l3 = l2;
      long l4;
      do
      {
        l4 = localFileChannel.transferTo(l3, 524288L, paramWritableByteChannel);
        l3 += l4;
        localFileChannel.position(l3);
      }
      while ((l4 > 0L) || (l3 < localFileChannel.size()));
      l1 = l3 - l2;
    }
    while (true)
    {
  ...
  public static ByteArrayDataOutput newDataOutput(int paramInt)
  {
    if (paramInt < 0)
    {
      ...
      throw new IllegalArgumentException(String.format("Invalid size: %s", arrayOfObject));
    }
