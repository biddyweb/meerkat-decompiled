...
public abstract interface zzs extends IInterface
{
    ...
    implements zzs
  {
      ...
      throws RemoteException
    {
      ...
      for (StreetViewPanoramaLocation localStreetViewPanoramaLocation = StreetViewPanoramaLocation.CREATOR.zzec(paramParcel1); ; localStreetViewPanoramaLocation = null)
      {
