  ...
  implements WebSocketListener
{
  ...
  {
    InetSocketAddress localInetSocketAddress = paramWebSocket.getLocalSocketAddress();
  ...
  {
    FramedataImpl1 localFramedataImpl1 = new FramedataImpl1(paramFramedata);
    localFramedataImpl1.setOptcode(Framedata.Opcode.PONG);
    paramWebSocket.sendFrame(localFramedataImpl1);
  }
