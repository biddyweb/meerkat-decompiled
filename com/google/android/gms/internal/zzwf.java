...
public abstract interface zzwf extends IInterface
{
  ...
  public static abstract class zza extends Binder
    implements zzwf
  {
    public static zzwf zzcL(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzwf)))
        return (zzwf)localIInterface;
