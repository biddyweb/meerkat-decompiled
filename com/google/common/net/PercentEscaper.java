...
public final class PercentEscaper extends UnicodeEscaper
{
  ...
  public PercentEscaper(String paramString, boolean paramBoolean)
  {
    ...
    String str = String.valueOf(paramString).concat("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789");
    if ((paramBoolean) && (str.contains(" ")))
  ...
  private static boolean[] createSafeOctets(String paramString)
  {
    ...
    for (int n = 0; n < m; n++)
      arrayOfBoolean[arrayOfChar[n]] = true;
