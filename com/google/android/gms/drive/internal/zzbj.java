  ...
  implements Parcelable.Creator<SetFileUploadPreferencesRequest>
{
  static void zza(SetFileUploadPreferencesRequest paramSetFileUploadPreferencesRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, paramSetFileUploadPreferencesRequest.zzFG);
    zzb.zza(paramParcel, 2, paramSetFileUploadPreferencesRequest.zzUQ, paramInt, false);
    zzb.zzH(paramParcel, i);
  }

  public SetFileUploadPreferencesRequest zzaV(Parcel paramParcel)
  {
  ...
  public SetFileUploadPreferencesRequest[] zzco(int paramInt)
  {
