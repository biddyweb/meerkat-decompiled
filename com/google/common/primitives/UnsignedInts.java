...
public final class UnsignedInts
{
  ...
  public static int decode(String paramString)
  {
    ...
    for (String str2 = "Error parsing value: ".concat(str1); ; str2 = new String("Error parsing value: "))
    {
      NumberFormatException localNumberFormatException2 = new NumberFormatException(str2);
  ...
  public static int parseUnsignedInt(String paramString, int paramInt)
  {
    ...
    if ((0xFFFFFFFF & l) != l)
    {
      ...
      throw new NumberFormatException(69 + str.length() + "Input " + str + " in base " + paramInt + " is not in the range of an unsigned integer");
    }
    return (int)l;
  }
