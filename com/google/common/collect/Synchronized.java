...
final class Synchronized
{
  ...
  @GwtIncompatible("Deque")
  private static final class SynchronizedDeque<E> extends Synchronized.SynchronizedQueue<E>
    implements Deque<E>
  {
    private static final long serialVersionUID;
    ...
    public E getFirst()
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().getFirst();
        return localObject3;
      }
    }
    ...
    public E getLast()
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().getLast();
        return localObject3;
      }
    }
    ...
    public E peekFirst()
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().peekFirst();
        return localObject3;
      }
    }
    ...
    public E peekLast()
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().peekLast();
        return localObject3;
      }
    }
    ...
    public E pollFirst()
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().pollFirst();
        return localObject3;
      }
    }
    ...
    public E pollLast()
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().pollLast();
        return localObject3;
      }
    }
    ...
    public E pop()
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().pop();
        return localObject3;
      }
    }
    ...
    public E removeFirst()
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().removeFirst();
        return localObject3;
      }
    }
    ...
    public E removeLast()
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().removeLast();
        return localObject3;
      }
    }
    ...
    implements Map.Entry<K, V>
  {
    ...
    public K getKey()
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().getKey();
        return localObject3;
      }
    }
    ...
    public V getValue()
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().getValue();
        return localObject3;
      }
    }
    ...
    public V setValue(V paramV)
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().setValue(paramV);
        return localObject3;
      }
    }
  }
    ...
    implements NavigableMap<K, V>
  {
    ...
    public Map.Entry<K, V> ceilingEntry(K paramK)
    {
      synchronized (this.mutex)
      {
        Map.Entry localEntry = Synchronized.nullableSynchronizedEntry(delegate().ceilingEntry(paramK), this.mutex);
        return localEntry;
      }
    }
    ...
    public K ceilingKey(K paramK)
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().ceilingKey(paramK);
        return localObject3;
      }
    }
    ...
    public NavigableSet<K> descendingKeySet()
    {
      synchronized (this.mutex)
      {
        ...
        {
          NavigableSet localNavigableSet2 = Synchronized.navigableSet(delegate().descendingKeySet(), this.mutex);
          this.descendingKeySet = localNavigableSet2;
          return localNavigableSet2;
        }
        NavigableSet localNavigableSet1 = this.descendingKeySet;
        return localNavigableSet1;
      }
    }
    ...
    public NavigableMap<K, V> descendingMap()
    {
      synchronized (this.mutex)
      {
        ...
        {
          NavigableMap localNavigableMap2 = Synchronized.navigableMap(delegate().descendingMap(), this.mutex);
          this.descendingMap = localNavigableMap2;
          return localNavigableMap2;
        }
        NavigableMap localNavigableMap1 = this.descendingMap;
        return localNavigableMap1;
      }
    }
    ...
    public Map.Entry<K, V> floorEntry(K paramK)
    {
      synchronized (this.mutex)
      {
        Map.Entry localEntry = Synchronized.nullableSynchronizedEntry(delegate().floorEntry(paramK), this.mutex);
        return localEntry;
      }
    }
    ...
    public K floorKey(K paramK)
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().floorKey(paramK);
        return localObject3;
      }
    }
    ...
    public NavigableMap<K, V> headMap(K paramK, boolean paramBoolean)
    {
      synchronized (this.mutex)
      {
        NavigableMap localNavigableMap = Synchronized.navigableMap(delegate().headMap(paramK, paramBoolean), this.mutex);
    ...
    public Map.Entry<K, V> higherEntry(K paramK)
    {
      synchronized (this.mutex)
      {
        Map.Entry localEntry = Synchronized.nullableSynchronizedEntry(delegate().higherEntry(paramK), this.mutex);
        return localEntry;
      }
    }
    ...
    public K higherKey(K paramK)
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().higherKey(paramK);
        return localObject3;
      }
    }
    ...
    public Map.Entry<K, V> lowerEntry(K paramK)
    {
      synchronized (this.mutex)
      {
        Map.Entry localEntry = Synchronized.nullableSynchronizedEntry(delegate().lowerEntry(paramK), this.mutex);
        return localEntry;
      }
    }
    ...
    public K lowerKey(K paramK)
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().lowerKey(paramK);
        return localObject3;
      }
    }
    ...
    public NavigableSet<K> navigableKeySet()
    {
      synchronized (this.mutex)
      {
        ...
        {
          NavigableSet localNavigableSet2 = Synchronized.navigableSet(delegate().navigableKeySet(), this.mutex);
          this.navigableKeySet = localNavigableSet2;
          return localNavigableSet2;
        }
        NavigableSet localNavigableSet1 = this.navigableKeySet;
        return localNavigableSet1;
      }
    }
    ...
    public NavigableMap<K, V> subMap(K paramK1, boolean paramBoolean1, K paramK2, boolean paramBoolean2)
    {
      synchronized (this.mutex)
      {
        NavigableMap localNavigableMap = Synchronized.navigableMap(delegate().subMap(paramK1, paramBoolean1, paramK2, paramBoolean2), this.mutex);
        return localNavigableMap;
      }
    }
    ...
    public NavigableMap<K, V> tailMap(K paramK, boolean paramBoolean)
    {
      synchronized (this.mutex)
      {
        NavigableMap localNavigableMap = Synchronized.navigableMap(delegate().tailMap(paramK, paramBoolean), this.mutex);
        return localNavigableMap;
      }
    }
    ...
    implements NavigableSet<E>
  {
    ...
    public E ceiling(E paramE)
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().ceiling(paramE);
        return localObject3;
      }
    }
    ...
    public NavigableSet<E> descendingSet()
    {
      synchronized (this.mutex)
      {
        ...
        {
          NavigableSet localNavigableSet2 = Synchronized.navigableSet(delegate().descendingSet(), this.mutex);
          this.descendingSet = localNavigableSet2;
          return localNavigableSet2;
        }
        NavigableSet localNavigableSet1 = this.descendingSet;
        return localNavigableSet1;
      }
    }
    ...
    public E floor(E paramE)
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().floor(paramE);
        return localObject3;
      }
    }
    ...
    public NavigableSet<E> headSet(E paramE, boolean paramBoolean)
    {
      synchronized (this.mutex)
      {
        NavigableSet localNavigableSet = Synchronized.navigableSet(delegate().headSet(paramE, paramBoolean), this.mutex);
    ...
    public E higher(E paramE)
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().higher(paramE);
        return localObject3;
      }
    }
    ...
    public E lower(E paramE)
    {
      synchronized (this.mutex)
      {
        Object localObject3 = delegate().lower(paramE);
        return localObject3;
      }
    }
    ...
    public NavigableSet<E> subSet(E paramE1, boolean paramBoolean1, E paramE2, boolean paramBoolean2)
    {
      synchronized (this.mutex)
      {
        NavigableSet localNavigableSet = Synchronized.navigableSet(delegate().subSet(paramE1, paramBoolean1, paramE2, paramBoolean2), this.mutex);
        return localNavigableSet;
      }
    }
    ...
    public NavigableSet<E> tailSet(E paramE, boolean paramBoolean)
    {
      synchronized (this.mutex)
      {
        NavigableSet localNavigableSet = Synchronized.navigableSet(delegate().tailSet(paramE, paramBoolean), this.mutex);
        return localNavigableSet;
      }
    }
