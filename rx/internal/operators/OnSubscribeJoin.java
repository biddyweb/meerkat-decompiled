  ...
  final class ResultSink
  {
    ...
    final class LeftSubscriber extends Subscriber<TLeft>
    {
      ...
      protected void expire(int paramInt, Subscription paramSubscription)
      {
        ...
        {
          Object localObject3 = OnSubscribeJoin.ResultSink.this.leftMap.remove(Integer.valueOf(paramInt));
          int i = 0;
      ...
      public void onNext(TLeft paramTLeft)
      {
        ...
        synchronized (OnSubscribeJoin.ResultSink.this.guard)
        {
          OnSubscribeJoin.ResultSink localResultSink = OnSubscribeJoin.ResultSink.this;
          int i = localResultSink.leftId;
          localResultSink.leftId = (i + 1);
        ...
        while (localIterator2.hasNext())
        {
          ...
          Object localObject6 = OnSubscribeJoin.this.resultSelector.call(paramTLeft, localObject5);
          OnSubscribeJoin.ResultSink.this.subscriber.onNext(localObject6);
        }
      }
    ...
    final class RightSubscriber extends Subscriber<TRight>
    {
      ...
      void expire(int paramInt, Subscription paramSubscription)
      {
        synchronized (OnSubscribeJoin.ResultSink.this.guard)
        {
          Object localObject3 = OnSubscribeJoin.ResultSink.this.rightMap.remove(Integer.valueOf(paramInt));
          int i = 0;
          if (localObject3 != null)
          {
      ...
      public void onNext(TRight paramTRight)
      {
        ...
        {
          OnSubscribeJoin.ResultSink localResultSink = OnSubscribeJoin.ResultSink.this;
          int i = localResultSink.rightId;
          localResultSink.rightId = (i + 1);
        ...
        {
          Object localObject5 = localIterator2.next();
          Object localObject6 = OnSubscribeJoin.this.resultSelector.call(localObject5, paramTRight);
          OnSubscribeJoin.ResultSink.this.subscriber.onNext(localObject6);
        }
      }
