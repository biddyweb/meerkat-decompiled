...
public class FieldUtils
{
  ...
  public static int getWrappedValue(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    int i = 1 + (paramInt3 - paramInt2);
    int j = paramInt1 - paramInt2;
    if (j >= 0)
      return paramInt2 + j % i;
    int k = -j % i;
    if (k == 0)
      return paramInt2 + 0;
    return paramInt2 + (i - k);
  }
  ...
  {
    if ((paramLong1 == -9223372036854775808L) && (paramLong2 == -1L))
  ...
  public static long safeMultiply(long paramLong1, long paramLong2)
  {
    ...
    if ((paramLong1 == 0L) || (paramLong2 == 0L))
      return 0L;
    long l = paramLong1 * paramLong2;
    if ((l / paramLong2 != paramLong1) || ((paramLong1 == -9223372036854775808L) && (paramLong2 == -1L)) || ((paramLong2 == -9223372036854775808L) && (paramLong1 == -1L)))
      throw new ArithmeticException("Multiplication overflows a long: " + paramLong1 + " * " + paramLong2);
    return l;
  }
