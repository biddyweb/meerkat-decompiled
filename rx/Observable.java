...
public class Observable<T>
{
  ...
  {
    return interval(paramLong, paramTimeUnit, Schedulers.computation());
  }

  public static final Observable<Long> interval(long paramLong, TimeUnit paramTimeUnit, Scheduler paramScheduler)
  {
    return create(new OnSubscribeTimerPeriodically(paramLong, paramLong, paramTimeUnit, paramScheduler));
  }
  ...
  {
    return paramObservable.lift(new OperatorMergeMaxConcurrent(paramInt));
  }
  ...
  {
    return timer(paramLong1, paramLong2, paramTimeUnit, Schedulers.computation());
  }
  ...
  {
    return lift(new OperatorScan(paramFunc0, new Func2()
    {
  ...
  public final Observable<Integer> count()
  {
    ...
    {
      public final Integer call(Integer paramAnonymousInteger, T paramAnonymousT)
      {
  ...
  public final Observable<Long> countLong()
  {
    ...
    {
      public final Long call(Long paramAnonymousLong, T paramAnonymousT)
      {
  ...
  {
    return lift(new OperatorDefaultIfEmpty(paramT));
  }
  ...
  {
    return lift(new OperatorDistinct(UtilityFunctions.identity()));
  }
  ...
  {
    return lift(new OperatorDistinctUntilChanged(UtilityFunctions.identity()));
  }
      ...
      public void call(Subscriber<? super R> paramAnonymousSubscriber)
      {
        ...
        catch (Throwable localThrowable1)
        {
          ...
          if ((localThrowable1 instanceof OnErrorNotImplementedException))
          {
            ...
            label67: localSubscriber.onError(localThrowable2);
            return;
          }
  ...
  {
    return lift(new OperatorOnBackpressureBuffer());
  }
  ...
  public final Observable<T> repeatWhen(final Func1<? super Observable<? extends Void>, ? extends Observable<?>> paramFunc1)
  {
    return OnSubscribeRedo.repeat(this, new Func1()
    {
      ...
      {
        return (Observable)paramFunc1.call(paramAnonymousObservable.map(new Func1()
        {
  ...
  {
    return lift(new OperatorSingle());
  }
  ...
  {
    return lift(new OperatorToObservableSortedList(paramFunc2));
  }
  ...
  {
    return lift(new OperatorWindowWithObservable(paramFunc0));
  }
