  ...
  implements Requests
{
  ...
  public PendingResult<Requests.UpdateRequestsResult> acceptRequests(GoogleApiClient paramGoogleApiClient, List<String> paramList)
  {
    ...
    for (final String[] arrayOfString = null; ; arrayOfString = (String[])paramList.toArray(new String[paramList.size()]))
      return paramGoogleApiClient.zzb(new UpdateRequestsImpl(paramGoogleApiClient, arrayOfString)
      {
        protected void zza(GamesClientImpl paramAnonymousGamesClientImpl)
          throws RemoteException
        {
          paramAnonymousGamesClientImpl.zzb(this, arrayOfString);
        }
      });
  }
    ...
    for (final String[] arrayOfString = null; ; arrayOfString = (String[])paramList.toArray(new String[paramList.size()]))
      return paramGoogleApiClient.zzb(new UpdateRequestsImpl(paramGoogleApiClient, arrayOfString)
      {
        protected void zza(GamesClientImpl paramAnonymousGamesClientImpl)
          throws RemoteException
        {
          paramAnonymousGamesClientImpl.zzc(this, arrayOfString);
        }
      });
  }
  ...
  {
    return paramGoogleApiClient.zza(new LoadRequestsImpl(paramGoogleApiClient, paramInt1)
    {
      protected void zza(GamesClientImpl paramAnonymousGamesClientImpl)
        throws RemoteException
      {
  ...
  public void registerRequestListener(GoogleApiClient paramGoogleApiClient, OnRequestReceivedListener paramOnRequestReceivedListener)
  {
    ...
    if (localGamesClientImpl != null)
      localGamesClientImpl.zzd(paramGoogleApiClient.zzf(paramOnRequestReceivedListener));
  }
  ...
  {
    public Requests.LoadRequestSummariesResult zzaj(final Status paramStatus)
    {
  ...
  private static abstract class LoadRequestsImpl extends Games.BaseGamesApiMethodImpl<Requests.LoadRequestsResult>
  {
    ...
    public Requests.LoadRequestsResult zzak(final Status paramStatus)
    {
      return new Requests.LoadRequestsResult()
      {
        public GameRequestBuffer getRequests(int paramAnonymousInt)
        {
          return new GameRequestBuffer(DataHolder.zzay(paramStatus.getStatusCode()));
        }
  ...
  {
    public Requests.SendRequestResult zzal(final Status paramStatus)
    {
  ...
  private static abstract class UpdateRequestsImpl extends Games.BaseGamesApiMethodImpl<Requests.UpdateRequestsResult>
  {
    ...
    public Requests.UpdateRequestsResult zzam(final Status paramStatus)
    {
