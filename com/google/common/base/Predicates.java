...
public final class Predicates
{
    ...
    implements Predicate<T>, Serializable
  {
    ...
    public String toString()
    {
      ...
      return 16 + str.length() + "Predicates.and(" + str + ")";
    }
  }
    ...
    implements Predicate<Class<?>>, Serializable
  {
    ...
    public String toString()
    {
      ...
      return 27 + str.length() + "Predicates.assignableFrom(" + str + ")";
    }
  }
    ...
    implements Predicate<A>, Serializable
  {
    ...
    public String toString()
    {
      String str1 = String.valueOf(String.valueOf(this.p.toString()));
      String str2 = String.valueOf(String.valueOf(this.f.toString()));
  ...
  private static class ContainsPatternFromStringPredicate extends Predicates.ContainsPatternPredicate
  {
    ...
    ContainsPatternFromStringPredicate(String paramString)
    {
      super();
    }
    ...
    public String toString()
    {
      ...
      return 28 + str.length() + "Predicates.containsPattern(" + str + ")";
    }
  }
    ...
    implements Predicate<CharSequence>, Serializable
  {
    ...
    public String toString()
    {
      String str = String.valueOf(String.valueOf(Objects.toStringHelper(this.pattern).add("pattern", this.pattern.pattern()).add("pattern.flags", this.pattern.flags()).toString()));
      return 21 + str.length() + "Predicates.contains(" + str + ")";
    }
  }
    ...
    implements Predicate<T>, Serializable
  {
    ...
    public String toString()
    {
      ...
      return 15 + str.length() + "Predicates.in(" + str + ")";
    }
  }
    ...
    implements Predicate<Object>, Serializable
  {
    ...
    {
      String str = String.valueOf(String.valueOf(this.clazz.getName()));
      return 23 + str.length() + "Predicates.instanceOf(" + str + ")";
    }
  }
    ...
    implements Predicate<T>, Serializable
  {
    ...
    {
      String str = String.valueOf(String.valueOf(this.target));
      return 20 + str.length() + "Predicates.equalTo(" + str + ")";
    }
  }
    ...
    implements Predicate<T>, Serializable
  {
    ...
    public String toString()
    {
      ...
      return 16 + str.length() + "Predicates.not(" + str + ")";
    }
  }
    ...
    implements Predicate<Object>
  {
    ...
    {
      // Byte code:
      //   0: new 18\011com/google/common/base/Predicates$ObjectPredicate$1
      //   3: dup
      //   4: ldc 19
      //   6: iconst_0
      //   7: invokespecial 23\011com/google/common/base/Predicates$ObjectPredicate$1:<init>\011(Ljava/lang/String;I)V
      //   10: putstatic 25\011com/google/common/base/Predicates$ObjectPredicate:ALWAYS_TRUE\011Lcom/google/common/base/Predicates$ObjectPredicate;
      //   13: new 27\011com/google/common/base/Predicates$ObjectPredicate$2
      //   16: dup
      //   17: ldc 28
      //   19: iconst_1
      //   20: invokespecial 29\011com/google/common/base/Predicates$ObjectPredicate$2:<init>\011(Ljava/lang/String;I)V
      //   23: putstatic 31\011com/google/common/base/Predicates$ObjectPredicate:ALWAYS_FALSE\011Lcom/google/common/base/Predicates$ObjectPredicate;
      //   26: new 33\011com/google/common/base/Predicates$ObjectPredicate$3
      //   29: dup
      //   30: ldc 34
      //   32: iconst_2
      //   33: invokespecial 35\011com/google/common/base/Predicates$ObjectPredicate$3:<init>\011(Ljava/lang/String;I)V
      //   36: putstatic 37\011com/google/common/base/Predicates$ObjectPredicate:IS_NULL\011Lcom/google/common/base/Predicates$ObjectPredicate;
      //   39: new 39\011com/google/common/base/Predicates$ObjectPredicate$4
      //   42: dup
      //   43: ldc 40
      //   45: iconst_3
      //   46: invokespecial 41\011com/google/common/base/Predicates$ObjectPredicate$4:<init>\011(Ljava/lang/String;I)V
      //   49: putstatic 43\011com/google/common/base/Predicates$ObjectPredicate:NOT_NULL\011Lcom/google/common/base/Predicates$ObjectPredicate;
      //   52: iconst_4
      //   53: anewarray 2\011com/google/common/base/Predicates$ObjectPredicate
      //   56: astore_0
      //   57: aload_0
      //   58: iconst_0
      //   59: getstatic 25\011com/google/common/base/Predicates$ObjectPredicate:ALWAYS_TRUE\011Lcom/google/common/base/Predicates$ObjectPredicate;
      //   62: aastore
      //   63: aload_0
      //   64: iconst_1
      //   65: getstatic 31\011com/google/common/base/Predicates$ObjectPredicate:ALWAYS_FALSE\011Lcom/google/common/base/Predicates$ObjectPredicate;
      //   68: aastore
      //   69: aload_0
      //   70: iconst_2
      //   71: getstatic 37\011com/google/common/base/Predicates$ObjectPredicate:IS_NULL\011Lcom/google/common/base/Predicates$ObjectPredicate;
      //   74: aastore
      //   75: aload_0
      //   76: iconst_3
      //   77: getstatic 43\011com/google/common/base/Predicates$ObjectPredicate:NOT_NULL\011Lcom/google/common/base/Predicates$ObjectPredicate;
      //   80: aastore
      //   81: aload_0
      //   82: putstatic 45\011com/google/common/base/Predicates$ObjectPredicate:$VALUES\011[Lcom/google/common/base/Predicates$ObjectPredicate;
      //   85: return
    }
    ...
    implements Predicate<T>, Serializable
  {
    ...
    {
      String str = String.valueOf(String.valueOf(Predicates.COMMA_JOINER.join(this.components)));
      return 15 + str.length() + "Predicates.or(" + str + ")";
    }
  }
}