...
.method private checkForUpdates(Landroid/content/Context;Lio/fabric/sdk/android/services/common/IdManager;Lio/fabric/sdk/android/services/settings/BetaSettingsData;Lcom/crashlytics/android/beta/BuildProperties;)V
    ...
    .param p3, "betaSettings"    # Lio/fabric/sdk/android/services/settings/BetaSettingsData;
    .param p4, "buildProps"    # Lcom/crashlytics/android/beta/BuildProperties;
...
.method private getBetaDeviceToken(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v5, "App was installed by Beta. Getting device token"
...
.method protected doInBackground()Ljava/lang/Boolean;
    ...
    const-string v8, "Beta kit initializing..."
    ...
    .line 53
    .local v4, "idManager":Lio/fabric/sdk/android/services/common/IdManager;
    ...
    invoke-direct {p0, v3, v5}, Lcom/crashlytics/android/beta/Beta;->getBetaDeviceToken(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v8, "A Beta device token was not found for this app"
    ...
    const-string v8, "Beta device token is present, checking for app updates."
    ...
    invoke-direct {p0, v3}, Lcom/crashlytics/android/beta/Beta;->loadBuildProperties(Landroid/content/Context;)Lcom/crashlytics/android/beta/BuildProperties;

    move-result-object v2

    .line 66
    .local v2, "buildProps":Lcom/crashlytics/android/beta/BuildProperties;
    invoke-virtual {p0, v1, v2}, Lcom/crashlytics/android/beta/Beta;->canCheckForUpdates(Lio/fabric/sdk/android/services/settings/BetaSettingsData;Lcom/crashlytics/android/beta/BuildProperties;)Z
    ...
    .line 67
    invoke-direct {p0, v3, v4, v1, v2}, Lcom/crashlytics/android/beta/Beta;->checkForUpdates(Landroid/content/Context;Lio/fabric/sdk/android/services/common/IdManager;Lio/fabric/sdk/android/services/settings/BetaSettingsData;Lcom/crashlytics/android/beta/BuildProperties;)V
