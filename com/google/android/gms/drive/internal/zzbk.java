  ...
  implements Parcelable.Creator<SetResourceParentsRequest>
{
  static void zza(SetResourceParentsRequest paramSetResourceParentsRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, paramSetResourceParentsRequest.zzFG);
    zzb.zza(paramParcel, 2, paramSetResourceParentsRequest.zzVe, paramInt, false);
    zzb.zzc(paramParcel, 3, paramSetResourceParentsRequest.zzVf, false);
    zzb.zzH(paramParcel, i);
  }

  public SetResourceParentsRequest zzaW(Parcel paramParcel)
  {
  ...
  public SetResourceParentsRequest[] zzcp(int paramInt)
  {
