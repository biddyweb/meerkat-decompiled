  ...
  implements Predicate<C>, Serializable
{
  ...
  static
  {
    RANGE_LEX_ORDERING = new Range.3();
  }
  ...
  private Range(Cut<C> paramCut1, Cut<C> paramCut2)
  {
    ...
    {
      String str1 = String.valueOf(toString(paramCut1, paramCut2));
      if (str1.length() != 0);
      for (String str2 = "Invalid range: ".concat(str1); ; str2 = new String("Invalid range: "))
  ...
  {
    switch (Range.4.$SwitchMap$com$google$common$collect$BoundType[paramBoundType.ordinal()])
    {
    default:
