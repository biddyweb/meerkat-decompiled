...
public final class ZeroIsMaxDateTimeField extends DecoratedDateTimeField
{
  ...
  {
    return 1 + getWrappedField().getMaximumValue();
  }

  public int getMaximumValue(long paramLong)
  {
    return 1 + getWrappedField().getMaximumValue(paramLong);
  }

  public int getMaximumValue(ReadablePartial paramReadablePartial)
  {
    return 1 + getWrappedField().getMaximumValue(paramReadablePartial);
  }

  public int getMaximumValue(ReadablePartial paramReadablePartial, int[] paramArrayOfInt)
  {
    return 1 + getWrappedField().getMaximumValue(paramReadablePartial, paramArrayOfInt);
  }
