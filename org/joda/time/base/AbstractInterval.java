  ...
  implements ReadableInterval
{
  ...
  {
    if (this == paramObject);
    ReadableInterval localReadableInterval;
    do
    {
      return true;
      if (!(paramObject instanceof ReadableInterval))
        return false;
      localReadableInterval = (ReadableInterval)paramObject;
    }
    while ((getStartMillis() == localReadableInterval.getStartMillis()) && (getEndMillis() == localReadableInterval.getEndMillis()) && (FieldUtils.equals(getChronology(), localReadableInterval.getChronology())));
    return false;
  }
  ...
  public int hashCode()
  {
    long l1 = getStartMillis();
    long l2 = getEndMillis();
    return 31 * (31 * (3007 + (int)(l1 ^ l1 >>> 32)) + (int)(l2 ^ l2 >>> 32)) + getChronology().hashCode();
  }
