...
public final class Functions
{
    ...
    implements Function<Object, E>, Serializable
  {
    ...
    public String toString()
    {
      ...
      return 10 + str.length() + "constant(" + str + ")";
    }
  }
    ...
    implements Function<K, V>, Serializable
  {
    ...
    public String toString()
    {
      String str1 = String.valueOf(String.valueOf(this.map));
      String str2 = String.valueOf(String.valueOf(this.defaultValue));
      return 23 + str1.length() + str2.length() + "forMap(" + str1 + ", defaultValue=" + str2 + ")";
    }
  }
    ...
    implements Function<A, C>, Serializable
  {
    ...
    public String toString()
    {
      String str1 = String.valueOf(String.valueOf(this.g));
      String str2 = String.valueOf(String.valueOf(this.f));
    ...
    implements Function<K, V>, Serializable
  {
    ...
    public String toString()
    {
      ...
      return 8 + str.length() + "forMap(" + str + ")";
    }
  }
    ...
    implements Function<T, Boolean>, Serializable
  {
    ...
    public String toString()
    {
      ...
      return 14 + str.length() + "forPredicate(" + str + ")";
    }
  }
    ...
    implements Function<Object, T>, Serializable
  {
    ...
    public String toString()
    {
      ...
      return 13 + str.length() + "forSupplier(" + str + ")";
    }
  }
