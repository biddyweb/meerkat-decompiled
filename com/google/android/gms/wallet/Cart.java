  ...
  implements SafeParcelable
{
  ...
  {
    this.zzFG = paramInt;
    this.zzaCR = paramString1;
    this.zzaCS = paramString2;
    this.zzaCT = paramArrayList;
  }
  ...
  public final class Builder
  {
    ...
    {
      Cart.this.zzaCT.add(paramLineItem);
      return this;
    }
    ...
    {
      Cart.this.zzaCS = paramString;
      return this;
    }

    public Builder setLineItems(List<LineItem> paramList)
    {
      Cart.this.zzaCT.clear();
      Cart.this.zzaCT.addAll(paramList);
      return this;
    }

    public Builder setTotalPrice(String paramString)
    {
      Cart.this.zzaCR = paramString;
      return this;
    }
  }
}