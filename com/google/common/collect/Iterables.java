...
public final class Iterables
{
  ...
  public static <T> T get(Iterable<? extends T> paramIterable, int paramInt, @Nullable T paramT)
  {
    ...
    if ((paramIterable instanceof List))
    {
      List localList = Lists.cast(paramIterable);
      if (paramInt < localList.size())
        paramT = localList.get(paramInt);
      return paramT;
    }
    Iterator localIterator = paramIterable.iterator();
    Iterators.advance(localIterator, paramInt);
    return Iterators.getNext(localIterator, paramT);
  }
  ...
  {
    return new TransformedIterator(paramIterable.iterator())
    {
